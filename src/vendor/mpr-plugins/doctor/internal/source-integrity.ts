...
// NOTE (ported 4 ก.ค., adapted for volt 5 ก.ค.): 26.5.x defines DoctorCheck in
// ./stale-peers, but this node runs 26.6.14-alpha where ./stale-peers ships only
// a minimal {name,ok,message} shape — the full {severity,details,fix} DoctorCheck
// lives in ../impl. Import from ../impl so this check's return type matches.
